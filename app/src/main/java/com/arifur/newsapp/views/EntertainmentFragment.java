...
public class EntertainmentFragment extends Fragment implements OnNewsListener {
    private static final String TAG = "EntertainmentFragment";
    final String q = "entertainment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mQueriedNewsRV = view.findViewById(R.id.entertainment_rv);
        initRecyclerView();
        return view;
    }
